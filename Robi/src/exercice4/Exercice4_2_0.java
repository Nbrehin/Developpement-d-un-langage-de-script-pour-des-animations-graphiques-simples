...
public class Exercice4_2_0 {
     ...
     * 
     * Crée une nouvelle instance de la classe Exercice4_2_0.
     * 
 ...
 * Classe SetDim
 * 
 * Permet de modifier la taille d'un élément graphique.
 */
...
class AddElement implements Command {
    ...
    public Reference run(Reference reference, SNode method) {
        ...
        ((GSpace) reference.getReceiver()).addElement((GElement) r.getReceiver());
